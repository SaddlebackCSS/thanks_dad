...
{
    // Create window
    sf::RenderWindow window(sf::VideoMode(1920, 1080), "Thor Particles");
    ...
    if (!texture.loadFromFile("/home/anthony/git/thanks_dad/assets/turkey.png"))
        return EXIT_FAILURE;

    if (!texture2.loadFromFile("/home/anthony/git/thanks_dad/assets/pie.png"))
        return EXIT_FAILURE;

    if (!texture3.loadFromFile("/home/anthony/git/thanks_dad/assets/turkey_plate.png"))
        return EXIT_FAILURE;

    if (!texture4.loadFromFile("/home/anthony/git/thanks_dad/assets/tiger.png"))
        return EXIT_FAILURE;

    sf::Texture textureAr[SIZE] = { texture, texture2, texture3, texture4};
   ...
   // system.addAffector( thor::AnimationAffector(colorizer) );
    ...
    sf::Font font;
    if (!font.loadFromFile("/home/anthony/git/thanks_dad/assets/sansation.ttf"))
        return 1;
            ...
            switch (event.type)
            {
                ...
                case sf::Event::KeyPressed:
                    ...
                    else
                    {
                        ...
                        system.setTexture(textureAr[index]);
                    }
